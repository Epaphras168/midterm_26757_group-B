    ...
    Optional<?> findByEmail(String email);
     ...
     @Query(value = """
        WITH RECURSIVE location_tree AS (
            SELECT id FROM locations WHERE name = :provinceName OR code = :provinceCode
            UNION ALL
        ...
        """, nativeQuery = true)
    List<User> findAllUsersInProvince(@Param("provinceName") String provinceName, @Param("provinceCode") String provinceCode);
